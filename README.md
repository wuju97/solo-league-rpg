...
- `Weapons.md` — Weapons & Equipment Engine: how any weapon actually functions
  (equipping, passives, hidden passives, crafting, upgrades) — separate from the 72
  named weapons themselves, which are Type 1 content in the `weapon_items` table
